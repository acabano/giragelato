<?php
/**
 * API endpoint to save giocate.json (play logs)
...
try {
    ...
    $playsPath = __DIR__ . '/../data/giocate.json';
    ...
    if (file_exists($playsPath) && !is_writable($playsPath)) {
        http_response_code(500);
    ...
    echo json_encode(['success' => true, 'message' => 'Play logs saved successfully']);
